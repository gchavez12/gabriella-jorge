...
![](../figs-gabriella-jorge/lobster_bar_plot.png){fig-cap="Dodged bar plot showing lobster counts by site, grouped by size category" fig-alt="Dodged bar plot showing lobster counts by site, grouped by size category"}
...
![](../figs-gabriella-jorge/lobster_dodged_bar_plot.png){fig-cap="Line plot showing lobster counts over time for multiple sites" fig-alt="Line plot showing lobster counts over time for multiple sites"}
