...
Santa Barbara Coastal LTER, D. Reed, and R. Miller. 2022. SBC LTER: Reef: Abundance, size and fishing effort for California Spiny Lobster (Panulirus interruptus), ongoing since 2012 ver 8. Environmental Data Initiative. https://doi.org/10.6073/pasta/25aa371650a671bafad64dd25a39ee18 (Accessed 2026-04-27).
...
![](../figs-gabriella-jorge/lobster_bar_plot.png){fig-alt="Dodged bar plot showing lobster counts by site, grouped by size category" fig-alt="Dodged bar plot showing lobster counts by site, grouped by size category"}
...
![](../figs-gabriella-jorge/lobster_dodged_bar_plot.png){fig-alt="Line plot showing lobster counts over time for multiple sites" fig-alt="Line plot showing lobster counts over time for multiple sites"}
...
![](../figs-gabriella-jorge/lobster_traps_plot_1.png) {fig-cap="Line plot showing temporal trends in total lobster trap counts across sites" fig-alt="Line plot of total lobster trap counts over time for multiple sites"}
...
![](../figs-gabriella-jorge/lobster_traps_plot_2.png) {fig-cap="Bar plot showing distribution of lobster trap counts by site and fishing pressure level" fig-alt="Bar plot of lobster trap counts by site grouped into high and low fishing pressure"}
